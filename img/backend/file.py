...
class SessionManager:
    ...
    def _cleanup_session(self, session_id):
        ...
        print(f"Session {session_id} expired and cleaned up ({deleted_count} files deleted)")
    ...
    def _load_or_generate_key(self):
        ...
        if os.path.exists(ENCRYPTION_KEY_FILE):
            ...
            with open(ENCRYPTION_KEY_FILE, 'wb') as key_file:
                key_file.write(key)
            print(f"Generated new transport encryption key: {ENCRYPTION_KEY_FILE}")
            return key
            ...
            if file and allowed_file(file.filename):
                try:
                    ...
                    uploaded_files.append({
                        ...
                        'size': file_size,
                        'file_hash': file_hash,
                        'storage_encrypted': False,  # Stored as plain file
                        'transport_secure': True     # Transport was secure
                    })
                ...
                if file_info:
                    ...
                    if os.path.exists(filepath):
                        ...
                        files.append({
                            ...
                            'image_url': f'/image/{filename}',  # Direct image URL for frontend display
                            'download_url': f'/download/{filename}'  # Download URL
                        })
        else:
...
if __name__ == '__main__':
    ...
    if os.environ.get('FLASK_ENV') == 'production':
        ...
        print("Use gunicorn: gunicorn -c gunicorn_config_file.py file:app")
    else:
        ...
        print("   gunicorn -c gunicorn_config_file.py file:app")
        print("")
        print("🔧 Development server starting...")
        print("API endpoints:")
        print("  POST /upload - Upload files")
        print("  GET /list - List files with image URLs")
        print("  GET /image/<filename> - Serve images directly")
        print("  GET /download/<filename> - Download files")
        print("  GET /view/<filename> - View file metadata")
